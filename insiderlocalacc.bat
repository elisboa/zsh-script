...
::feito por @erickrock80
for /f "tokens=6 delims=[]. " %%i in ('ver') do set build=%%i

if %build% LSS 17763 (
    echo =============================================================
    echo Script é compatível apenas com  Windows 10 v1809 ou superior
    echo =============================================================
    echo.
    pause
    goto :EOF
...
echo =====================================================
echo Necessario executar o Script como Administrador.
echo =====================================================
echo.
pause
goto :EOF
...
cls
set "choice="
echo Windows Insider - Conta local Offline
echo.
echo R - Entrar no modo Release Preview (Quase um LTS, o modo mais seguro)
echo S - Entrar no modo lento (Possui algumas novidades, com menos bugs)
echo F - Entrar no modo Rapido (Possui mais bugs, mas tem mais novidades)
echo.
echo X - Parar de receber builds do Insider Preview
echo Q - Sair sem fazer alteracoes
echo.
set /p choice="Choice: "
echo.
...
:ASK_FOR_REBOOT
set "choice="
echo Renicialização necessária para aplicar alterações.
set /p choice="Gostaria de reiniciar o seu computador agora? (y/N) "
